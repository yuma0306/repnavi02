<form {{ $attributes->merge(['class' => 'relative flex w-full h-14 overflow-hidden']) }}>
    <input type="text" name="keyword" id="keyword" placeholder="{{ $placeholder }}" class="w-full border-teal-600 rounded">
